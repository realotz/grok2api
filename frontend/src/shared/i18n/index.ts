  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        ssoRiskVideoBlocked: "risk≥0.8，禁止生成视频和 grok-4.5 / 4.6",
...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectSSOAllDescription: "读取 grok.com 的 policy / risk / event。检测结果会同步到关联的 Build 和 Console。risk=1 禁止视频和 grok-4.5 / 4.6。检测不会刷新或改写 SSO token。",
  detectSSOSelectedTitle: "检测选中的 {{count}} 个 SSO 账号风控？",
  detectSSOSelectedDescription: "逐个读取 grok.com 的 policy / risk / event，并同步到关联的 Build 和 Console。risk=1 禁止视频和 grok-4.5 / 4.6。不会刷新或改写 SSO token。",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  ...
  ssoRiskVideoBlocked: "risk≥0.8, video and grok-4.5 / 4.6 blocked",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectSSOAllDescription: "Read grok.com policy / risk / event. Results sync to linked Build and Console accounts. risk=1 blocks video and grok-4.5 / 4.6. This check does not refresh or rewrite SSO tokens.",
  detectSSOSelectedTitle: "Check SSO bot-risk for {{count}} selected accounts?",
  detectSSOSelectedDescription: "Read grok.com policy / risk / event and sync to linked Build and Console accounts. risk=1 blocks video and grok-4.5 / 4.6. SSO tokens are not refreshed or rewritten.",
