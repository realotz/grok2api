...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectSSOAllDescription: "读取 grok.com 的 botFlagSource / policy。被风控标记的账号会标为机器人。检测不会刷新或改写 SSO token。",
  detectSSOSelectedTitle: "检测选中的 {{count}} 个 SSO 账号风控？",
  detectSSOSelectedDescription: "逐个读取 grok.com 风控状态，并显示正常、机器人、失效和检测失败结果。不会刷新或改写 SSO token。",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectSSOAllDescription: "Read grok.com botFlagSource / policy. Risk-flagged accounts are marked as bots. This check does not refresh or rewrite SSO tokens.",
  detectSSOSelectedTitle: "Check SSO bot-risk for {{count}} selected accounts?",
  detectSSOSelectedDescription: "Read grok.com risk state for each selected account and show healthy, bot, invalid, and failed results. SSO tokens are not refreshed or rewritten.",
