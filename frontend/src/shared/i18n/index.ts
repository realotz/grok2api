    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldImageCount: "图片数量固定为 1；省略 n 或传 n=1。",
          ...
          fieldVideoExtendDuration: "本次新增片段时长；Console 范围 2 到 10 秒，Web 1.5 范围 6 到 10 秒，默认 6。",
          ...
          noteImageModels: "Web 使用 grok-imagine-image-2.0-web 统一提供 1K 质量生图与图片编辑，Basic、Super 和 Heavy 账号共享额度轮换；Console 的三个图片模型分别聚合展示生成与编辑能力。",
          noteImageCount: "图片生成与编辑仅接受 n=1，避免额外消耗上游账号额度。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldImageCount: "Image count is fixed at 1; omit n or pass n=1.",
          ...
          fieldVideoExtendDuration: "Length of the added segment. Console accepts 2-10 seconds; Web 1.5 accepts 6-10 seconds. The default is 6.",
          ...
          noteImageModels: "Web uses grok-imagine-image-2.0-web for both 1K quality generation and image editing, with quota rotation across Basic, Super, and Heavy accounts. Each of the three Console image models groups generation and edit capabilities.",
          noteImageCount: "Image generation and editing only accept n=1 to avoid consuming additional upstream account quota.",
