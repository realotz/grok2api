    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldReferenceAudios: "暂不支持。传入 reference_audios 会返回 400 invalid_request，不会创建视频任务。",
          ...
          noteVideoReference: "参考图视频走 /videos/generations + reference_images；只传 1 张也保持参考图语义，不会被当成首帧。网关最多接收 8 张，Console 路由最多 7 张；不可与 image 同用。参考图模式最高 720p。Console 的 grok-imagine-video 参考图模式最长 10 秒。reference_audios 暂不支持。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldReferenceAudios: "Temporarily unsupported. Supplying reference_audios returns 400 invalid_request without creating a video job.",
          ...
          noteVideoReference: "Reference-to-video uses /videos/generations with reference_images. A single item keeps reference semantics and is not promoted to a first frame. The gateway accepts up to 8 items and Console routes up to 7; do not combine them with image. Reference mode tops out at 720p. On Console, grok-imagine-video reference mode is limited to 10s. reference_audios is temporarily unsupported.",
