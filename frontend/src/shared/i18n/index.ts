  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        ssoRiskVideoBlocked: "risk≥1，禁止生成视频和 grok-4.5 / 4.6",
...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, unknown>, {
  ...
  modelTest: {
    action: "测试",
    title: "测试账号",
    description: "在 {{name}} 上试跑可用模型。文本检查约定 JSON；图片只预览；视频会真实生成并扣一次额度。",
    mediaPrompt: "图片 / 视频提示词",
    mediaPromptHint: "文本探测词是固定的。图片只看能不能出图，不改风控标记。视频走真实生成并扣额度；若 10 秒内就给出远程地址，会当成风控风景片并给账号打标。",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  ...
  ssoRiskVideoBlocked: "risk≥1, video and grok-4.5 / 4.6 blocked",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, unknown>, {
  ...
  modelTest: {
    action: "Test",
    title: "Test account",
    description: "Run the models available to {{name}}. Text checks a fixed JSON reply. Images only preview. Video really generates and uses one quota.",
    mediaPrompt: "Image / video prompt",
    mediaPromptHint: "Text uses a fixed probe. Images never change risk status. Video consumes one quota; a remote file ready within 10 seconds is treated as a risk scenery clip and the account is marked.",
