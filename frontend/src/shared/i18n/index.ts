  ...
  "zh-CN": {
    translation: {
      ...
      creativeConsole: {
        ...
        voiceSpeed: "语速",
        voiceLibrary: "音色库",
        voiceLibraryPhrase: "你好，这里是声音世界。我可以小声说话，也可以开心的笑，慢慢地讲，也可以大声哭，生气发火。",
        voiceLibraryTagsHint: "试听含停顿、耳语、笑声、慢声、哭声和生气，方便比较情绪与节奏。",
        playVoicePreview: "试听",
        stopVoicePreview: "停止",
        useVoicePhrase: "填入试听文案",
        selectedVoice: "已选",
        voiceGenderMale: "男",
        voiceGenderFemale: "女",
        voiceGenderGroupMale: "男声",
        voiceGenderGroupFemale: "女声",
        ...
        open: "打开",
        closeImageEditor: "退出图片编辑",
        toggleSegments: "切换分段面板",
        ...
        noSegments: "暂无可用分段",
        editImage: "编辑图片",
        imageEditPlaceholder: "描述你的编辑内容…",
        editingFullImage: "正在编辑整张图片",
        editingSegment: "正在编辑：{{name}}",
        applyImageEdit: "应用图片编辑",
        ...
        referenceVoice: "参考音频",
        referenceVoiceShort: "音频",
        referenceVoiceAdded: "已添加音频",
        referenceVoiceNone: "清除参考音频",
        referenceVoicePlaceholder: "eve 或 https://...",
        referenceVoiceUnavailable: "参考音频暂不支持",
        uploadImage: "上传本地图片",
        uploadVideo: "上传本地视频",
        duration: "时长（秒）",
        generateVideo: "生成视频",
      ...
      statusReauthRequired: "失效",
        ...
        ssoBotRiskTooltip: "SSO 机器人风控",
        ssoBotRiskTooltipSource1: "SSO 机器人风控（grok.com botFlagSource=1）",
        ssoBotRiskTooltipSource2: "SSO 机器人风控（grok.com botFlagSource=2）",
        ssoRiskMeter: "risk {{risk}}",
        ssoRiskPolicy: "policy={{policy}}",
        ssoRiskEvent: "event={{event}}",
        ssoRiskSource: "botFlagSource={{source}}",
        ssoRiskInspectedAt: "检测于 {{time}}",
        ssoRiskVideoBlocked: "risk≥0.8，grok-4.5 / 4.6 禁止调用；视频仍可调度，风险越低越优先",
      ...
      audits: {
        ...
        errorLabel: "错误",
        operations: { responses: "Responses", compaction: "上下文压缩", chat: "Chat", messages: "Messages", image: "图像生成", image_edit: "图像编辑", image_layer: "图像分层", video: "视频生成", tts: "语音合成", stt: "语音识别", realtime: "实时语音", voice: "语音" },
      ...
      settings: {
        ...
        accounts: {
          ...
          ssoVideoRiskEver: "历史风控",
          ssoVideoRiskEverHelp: "自动：正式视频不调度曾标记 risk=1 的账号。排除：始终不调度。允许：仅按当前风控阈值判断。账号模型测试不受此限制。",
          ssoVideoRiskEverAuto: "自动",
          ssoVideoRiskEverOn: "排除",
          ssoVideoRiskEverOff: "允许",
          ssoVideoRiskThreshold: "视频风控阈值",
          ssoVideoRiskThresholdHelp: "grok.com risk 达到该值时禁止正式视频调度。默认 1。填 0 表示不限制。账号模型测试不受此限制。",
          ssoLLMRiskThreshold: "LLM 风控阈值",
          ssoLLMRiskThresholdHelp: "grok.com risk 达到该值时禁止 grok-4.5 / 4.6 Build 文本调度。默认 0.8。填 0 表示不限制。",
          cleanupTitle: "账号清理",
      ...
      docs: {
        ...
        endpointImageLayers: "上传本地或远程图片到 Grok Web，返回 Imagine 分区 segmentation（对象框与 RLE 掩码）。",
        ...
        reference: {
          ...
          fieldAspectRatio: "输出媒体的宽高比。Web 图片支持 auto、1:1、2:3、3:2、4:3、3:4、9:16、16:9、21:9、5:2 等；空值按 auto 由上游推算。",
          fieldImageResolution: "Console 图片支持 1k/2k。Web 图片生成只把 size/resolution 映射为宽高比（空值或 auto 不强制分辨率），上游按 aspect_ratio 出图。",
          ...
          fieldEditImages: "待编辑图片，使用 image 或 images 传入 URL、Data URL 或已支持的图片引用；grok-imagine-image-2.0（含 Web 路由）最多 14 张。",
          fieldLayerImage: "待分层图片，使用 image 或 images 传入恰好 1 个 URL 或 Data URL。",
          fieldVideoPrompt: "视频描述。参考模式使用官方 <IMAGE_n>/<AUDIO_n> 标签（不区分大小写）绑定 reference_images/reference_audios；Web 会自动转成 @uuid。",
          fieldDuration: "视频时长（秒），范围 1–15。Web 免费账号仅支持 6 秒（480p/720p）；更长的 720p 走 Super，1080p 走 Heavy。Console 路由中，grok-imagine-video 的参考图模式最长 10 秒；grok-imagine-video-1.5 最长 15 秒。",
          ...
          fieldVideoExtendDuration: "本次新增片段时长；Console 范围 2 到 10 秒，Web 1.5 范围 6 到 10 秒，默认 6。Web 免费账号延长同样仅支持 6 秒。",
          fieldVideoExtensionStartTime: "Web 1.5 源视频的绝对结束时间（浮点秒）；首次 6 秒视频通常约为 6.04，再次延长可传累计后的时间。",
          fieldReferenceImages: "可选参考图片数组，用于参考图视频；grok-imagine-video-1.5 最多接收 14 张，旧模型保持原有限制。每项提供 url 或 file_id，不可与 image 同时使用。",
          fieldReferenceAudios: "可选参考音频，最多 3 段。voice_id 与 Build 一致（如 eve）；Web 还会把预置音色映射为 Imagine 资产，并额外接受 HTTPS url 或 Base64 data+format。不可与 image 同时使用，也不能在同一次请求里混用两种写法。prompt 用 <AUDIO_n> 引用。",
          ...
          noteImageLayers: "接口会把原图上传到 Grok Web，再调用 /rest/media/segment。返回 data[].segmentation，不是新生成的图片。仅 Web Imagine 账号可服务。",
          noteVideoAsync: "创建接口只返回 request_id；生成过程异步执行并持久化任务状态。",
          noteVideoDuration: "时长、比例、分辨率和图片输入按当前视频模型能力校验。",
          noteVideoReference: "参考图/参考音频走 /videos/generations。只传 1 张 reference_images 也保持参考语义，不会升格为首帧。grok-imagine-video-1.5 最多 14 张图，旧模型保持原有限制；参考音频最多 3 段。不可与 image 同用，参考模式最高 720p。prompt 使用官方 <IMAGE_n>/<AUDIO_n>（不区分大小写）。voice_id 三端一致；Web 会按 grok.com 预置音色目录（缓存 1 小时）映射为资产 UUID，自定义音频仍走 url/data。",
          noteVideoStrict: "视频接口严格使用当前官方字段，不保留旧项目的兼容别名。",
          noteVideoEditModel: "视频编辑使用 Console/grok-imagine-video；视频延长可使用该 Console 路由，或携带 video_extension_start_time 使用 Web/grok-imagine-video-1.5。Web 会重新上传源视频并新建会话。",
  ...
  en: {
    translation: {
      ...
      creativeConsole: {
        ...
        voiceLibraryPhrase: "Hello, this is the world of sound. I can speak softly, laugh with joy, talk slowly, cry out loud, and get angry.",
        voiceLibraryTagsHint: "Previews cover pause, whisper, laugh, slow speech, crying, and anger so you can compare emotion and rhythm.",
        playVoicePreview: "Preview",
        stopVoicePreview: "Stop",
        useVoicePhrase: "Use preview script",
        selectedVoice: "Selected",
        voiceGenderMale: "Male",
        voiceGenderFemale: "Female",
        voiceGenderGroupMale: "Male voices",
        voiceGenderGroupFemale: "Female voices",
        send: "Send",
        ...
        open: "Open",
        closeImageEditor: "Close image editor",
        toggleSegments: "Toggle segments panel",
        imageEditCanvas: "Image editing canvas",
        segments: "Segments",
        hideSegments: "Hide all segments",
        showSegments: "Show all segments",
        fullImage: "Full image",
        showSegment: "Show segment",
        hideSegment: "Hide segment",
        downloadSegment: "Download segment",
        deleteSegment: "Delete segment",
        noSegments: "No segments available",
        editImage: "Edit image",
        imageEditPlaceholder: "Describe your edit…",
        editingFullImage: "Editing full image",
        editingSegment: "Editing: {{name}}",
        ...
        referenceVoiceShort: "Audio",
        referenceVoiceAdded: "Audio added",
        referenceVoiceNone: "Clear reference audio",
        referenceVoicePlaceholder: "eve or https://...",
        referenceVoiceUnavailable: "Reference audio is temporarily unavailable",
      ...
      audits: {
        ...
        errorLabel: "Error",
        operations: { responses: "Responses", compaction: "Context compaction", chat: "Chat", messages: "Messages", image: "Image generation", image_edit: "Image edit", image_layer: "Image layers", video: "Video generation", tts: "Text to speech", stt: "Speech to text", realtime: "Realtime voice", voice: "Voice" },
      ...
      docs: {
        ...
        endpointImageLayers: "Upload a local or remote image to Grok Web and return Imagine segmentation (object boxes and RLE masks).",
        ...
        reference: {
          ...
          fieldAspectRatio: "Output aspect ratio. Web images accept auto, 1:1, 2:3, 3:2, 4:3, 3:4, 9:16, 16:9, 21:9, 5:2, and similar values. Empty values use auto so the model chooses.",
          fieldImageResolution: "Console images support 1k and 2k. Web image generation only maps size/resolution onto an aspect ratio; empty or auto does not force a pixel size. The upstream uses aspect_ratio.",
          ...
          fieldEditImages: "Source images supplied as URLs, data URLs, or another supported image reference. grok-imagine-image-2.0, including its Web route, accepts up to 14 images.",
          fieldLayerImage: "Source image for layer detection. Provide exactly one URL or data URL via image or images.",
          fieldVideoPrompt: "Video description. In reference mode, bind inputs with official <IMAGE_n>/<AUDIO_n> tags (case-insensitive). Web rewrites those tags to @uuid mentions.",
          fieldDuration: "Video duration in seconds, from 1 to 15. Web free accounts only support 6s at 480p/720p; longer 720p uses Super, and 1080p uses Heavy. On Console routes, reference-to-video is limited to 10s with grok-imagine-video and 15s with grok-imagine-video-1.5.",
          ...
          fieldVideoExtendDuration: "Length of the added segment. Console accepts 2-10 seconds; Web 1.5 accepts 6-10 seconds. The default is 6. Web free accounts can only extend by 6 seconds.",
          fieldVideoExtensionStartTime: "Absolute source-video end timestamp in fractional seconds for Web 1.5. A first 6-second clip is commonly around 6.04; later extensions use the accumulated timestamp.",
          fieldReferenceImages: "Optional reference image array for reference-to-video. grok-imagine-video-1.5 accepts up to 14 items; legacy models retain their existing limits. Each item uses url or file_id and cannot be combined with image.",
          fieldReferenceAudios: "Optional reference audio, up to 3 clips. voice_id matches Build (for example eve). Web also maps preset voices onto Imagine assets and still accepts an HTTPS url or Base64 data+format. Do not combine with image, and do not mix the two audio shapes in one request. Bind clips in prompt with <AUDIO_n>.",
          ...
          noteImageLayers: "The gateway uploads the source image to Grok Web and calls /rest/media/segment. The response is data[].segmentation, not a newly generated image. Only Web Imagine accounts can serve this route.",
          ...
          noteVideoReference: "Reference-to-video uses /videos/generations. A single reference_images item keeps reference semantics and is not promoted to a first frame. grok-imagine-video-1.5 accepts up to 14 images; legacy models retain their existing limits. Reference audio accepts up to 3 clips. Do not combine them with image. Reference mode tops out at 720p. Prompts use official <IMAGE_n>/<AUDIO_n> tags (case-insensitive). voice_id is the same on Web, Build, and Console; Web maps preset voices from the grok.com catalog (1-hour cache) to asset UUIDs, and still accepts custom url/data.",
          noteVideoStrict: "Video endpoints use the current official fields without non-standard aliases.",
          noteVideoEditModel: "Video edits use Console/grok-imagine-video. Extensions may use that Console route, or Web/grok-imagine-video-1.5 when video_extension_start_time is provided. Web re-uploads the source and starts a new conversation.",
...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectOutcome: { ok: "正常", flagged: "机器人", invalid: "失效", failed: "失败" },
  detectSSOAllTitle: "检测全部 SSO 账号风控？",
  detectSSOAllDescription: "读取 grok.com 的 policy / risk / event。检测结果会同步到关联的 Build 和 Console。risk≥0.8 禁止 grok-4.5 / 4.6；视频按风险从低到高、同风险按更早导入调度。检测不会刷新或改写 SSO token。",
  detectSSOSelectedTitle: "检测选中的 {{count}} 个 SSO 账号风控？",
  detectSSOSelectedDescription: "逐个读取 grok.com 的 policy / risk / event，并同步到关联的 Build 和 Console。risk≥0.8 禁止 grok-4.5 / 4.6；视频按风险从低到高、同风险按更早导入调度。不会刷新或改写 SSO token。",
  detectSSOSelectedSummary: "正常 {{ok}} · 机器人 {{flagged}} · 失效 {{invalid}} · 失败 {{failed}}",
  detectSSOFlaggedCount: "已发现 {{count}} 个风控或失效账号",
  detectWaitingSSOFlagged: "正在检测；这里只增量显示已确认风控或失效的账号。",
  detectNoSSOFlagged: "未发现风控或失效账号。",
  batchDetected: "账号检测完成：成功 {{succeeded}}，失败 {{failed}}",
  allDetected: "全量检测完成：成功 {{succeeded}}，失败 {{failed}}",
  modelTest: {
    action: "测试",
    title: "测试账号",
    description: "在 {{name}} 上试跑可用模型。文本检查约定 JSON；图片只预览；视频走正式生成任务，会进入视频库和请求审计。",
    mediaPrompt: "图片 / 视频提示词",
    mediaPromptHint: "文本探测词是固定的。图片只看能不能出图，不改风控标记。视频走正式任务：扣一次额度、写入视频库和请求审计；10 秒内给出远程地址会当成风控风景片并打标。",
    empty: "该账号暂无可测模型。可先在模型页同步能力后再试。",
    loadFailed: "读取可用模型失败",
    run: "测试",
    groupText: "文本模型",
    groupImage: "图片模型",
    groupVideo: "视频模型",
    imagePreview: "图片预览",
    videoPreviewFailed: "视频预览加载失败",
    outcome: { ok: "正常", flagged: "风控", error: "错误" },
  },
});
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  ssoRiskMeter: "risk {{risk}}",
  ...
  ssoRiskEvent: "event={{event}}",
  ssoRiskSource: "botFlagSource={{source}}",
  ssoRiskInspectedAt: "Inspected {{time}}",
  ssoRiskVideoBlocked: "risk≥0.8, grok-4.5 / 4.6 blocked; video still schedules, lower risk first",
  riskEver: "Historical risk",
  ssoRiskEver: "Previously marked risk=1",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectOutcome: { ok: "Healthy", flagged: "Bot", invalid: "Invalid", failed: "Failed" },
  detectSSOAllTitle: "Check SSO bot-risk for all accounts?",
  detectSSOAllDescription: "Read grok.com policy / risk / event. Results sync to linked Build and Console accounts. risk≥0.8 blocks grok-4.5 / 4.6. Video still schedules, preferring lower risk then earlier imports. This check does not refresh or rewrite SSO tokens.",
  detectSSOSelectedTitle: "Check SSO bot-risk for {{count}} selected accounts?",
  detectSSOSelectedDescription: "Read grok.com policy / risk / event and sync to linked Build and Console accounts. risk≥0.8 blocks grok-4.5 / 4.6. Video still schedules, preferring lower risk then earlier imports. SSO tokens are not refreshed or rewritten.",
  detectSSOSelectedSummary: "Healthy {{ok}} · Bot {{flagged}} · Invalid {{invalid}} · Failed {{failed}}",
  detectSSOFlaggedCount: "{{count}} risk-flagged or invalid accounts found",
  detectWaitingSSOFlagged: "Detection is running; confirmed bot-risk and invalid accounts appear here.",
  detectNoSSOFlagged: "No risk-flagged or invalid accounts found.",
  ...
  modelTest: {
    action: "Test",
    title: "Test account",
    description: "Run the models available to {{name}}. Text checks a fixed JSON reply. Images only preview. Video uses the normal generation job, so it appears in the gallery and request audit.",
    mediaPrompt: "Image / video prompt",
    mediaPromptHint: "Text uses a fixed probe. Images never change risk status. Video uses a real job: it consumes one quota and is written to the gallery and request audit. A remote file ready within 10 seconds is treated as a risk scenery clip.",
    empty: "No testable models for this account. Sync model capabilities first, then try again.",
    loadFailed: "Failed to load available models",
    run: "Test",
    groupText: "Text models",
    groupImage: "Image models",
    groupVideo: "Video models",
    imagePreview: "Image preview",
    videoPreviewFailed: "Video preview failed to load",
    outcome: { ok: "Healthy", flagged: "Risk", error: "Error" },
  },
});
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  freeConfirmedUsage: "{{used}} / {{limit}} tokens",
