        ...
        <Tabs defaultValue="build" className="flex min-w-0 flex-col gap-7 lg:flex-row lg:items-start">
          ...
          <SettingsSection title={t("settings.batch.title")}>
            <div className="space-y-0">
              ...
              <SettingsField controlId="batch-detect-concurrency" label={t("settings.batch.detectConcurrency")} description={t("settings.batch.detectConcurrencyHelp")} error={form.formState.errors.batch?.detectConcurrency?.message}><Input id="batch-detect-concurrency" type="number" min={1} max={50} {...form.register("batch.detectConcurrency", { valueAsNumber: true })} /></SettingsField>
