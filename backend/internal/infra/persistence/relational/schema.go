...
var schemaIndexes = []string{
	...
	"CREATE INDEX IF NOT EXISTS idx_account_credentials_sso_bot_flag ON account_credentials(sso_bot_flag_source, account_id)",
	"CREATE INDEX IF NOT EXISTS idx_account_credentials_sso_bot_risk_ever ON account_credentials(sso_bot_risk_ever, account_id)",
