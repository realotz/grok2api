...
func isStatsigAntiBotJSON(body []byte) bool {
	return isStatsigRefreshableMediaError(&webMediaUpstreamError{status: http.StatusForbidden, bodyKind: "json"}, body)
}
...
func resolveImageAspectRatio(aspectRatio, size string) (string, error) {
	values := map[string]string{
		...
		"3:2": "3:2", "2:3": "2:3", "2:1": "2:1", "1:2": "1:2", "21:9": "21:9", "9:21": "9:21",
		"5:2": "5:2", "2:5": "2:5", "19.5:9": "19.5:9", "9:19.5": "9:19.5", "20:9": "20:9", "9:20": "9:20",
		"1280x720": "16:9", "720x1280": "9:16", "1792x1024": "3:2", "1536x1024": "3:2", "1024x1792": "2:3", "1024x1536": "2:3", "1024x1024": "1:1",
		"2560x1080": "21:9", "1280x512": "5:2", "1920x768": "5:2",
	}
